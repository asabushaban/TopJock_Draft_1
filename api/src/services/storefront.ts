 ...
 * Storefront Service
 *
 * Service class used to execute scripts & transactions on the Flow blockchain to buy & sell TopJockNFT.
...
class StorefrontService {
  ...
  buy = (account: string, itemID: number) => {
    ...
    const transaction = fs
      ...
      .replace(topJockNFTPath, fcl.withPrefix(this.minterAddress))
      .replace(storefrontPath, fcl.withPrefix(this.storefrontAddress))
